...
var encourageMessages = ['Well Done 非常好','Keep It Up 加油','Excellent 太棒了','Continue 继续','Good Job 干得好',
'Great 真棒','Nice Work 漂亮','Fantastic 太奇妙','Do It Again 再来一次','Perfect 太完美','Almost 快了',]
...
HTMLActuator.prototype.updateScore = function (score) {
  ...
  if (difference > 0) {
    ...
    popMessage.classList.add("score-addition");
    popMessage.textContent = encourageMessages[Math.floor(Math.random() * encourageMessages.length)];
